...
# 3. ESTILOS CSS (OCULTAR ICONOS DE GITHUB, FOOTER Y STREAMLIT)
st.markdown(
    """
    <style>
    /* ------------------------------------------------------------- */
    /* OCULTAR ICONOS DE GITHUB, STREAMLIT, TOOLBAR Y FOOTER */
    /* ------------------------------------------------------------- */
    #MainMenu, 
    footer, 
    header, 
...
# ==============================================================================
# PANTALLA 4: PANEL DE SURTIDO EN VIVO (SIN ICONOS DE GITHUB / LIMPIO)
# ==============================================================================
